...
<body>
    ...
    <div class="content clearfix">
		...
		<div style="height:70px;">
				...
				<a href="/WebLaw/index.php/Manager/add_comment"><input type="button" value="增加" class="btn"></a>
		</div>
		<div style="padding:20px 100px;float:right;">
			 <form action="/WebLaw/index.php/Manager/search_comment" method='post' name='myForm'>
				...
				<?php if(is_array($data)): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
				    ...
				    <td align="center"><a href="/WebLaw/index.php/Manager/modify_comment/id/<?php echo ($vo["id"]); ?>"><input type="button" value="修改" class="btn"></a>
					    <a href="/WebLaw/index.php/Manager/del_comment/id/<?php echo ($vo["id"]); ?>"><input type="button" value="删除" class="btn"></a></td>
