...
<body>
	...
	<div class="login_cont">
            ...
            <form action='__URL__/create_comment' method='post' name='myForm'>
		<ul class="login">
			
		<li><span class="reg_item">内容：</span><div class="input_item"><input type='text' name='substance'class="login_input user_icon"/></div></li>
		<li><span class="reg_item">对象：</span><div class="input_item"><input type="text" name='username' class="login_input user_icon"/></div></li>
		<li><span class="reg_item">时间：</span><div class="input_item"><input type='text' name='time'  class="login_input user_icon"/></div></li>
		<li><span class="reg_item">发送人：</span><div class="input_item"><input type='text' name='who' class="login_input user_icon"/></div></li>
