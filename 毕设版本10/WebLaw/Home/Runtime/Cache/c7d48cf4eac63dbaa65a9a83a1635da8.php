...
<body>
	...
	<form action='__URL__/update_user' method='post' name='myForm'>
		<ul class="login">
		<br/>
		...
		<li><span class="reg_item">联系方式：</span><div class="input_item"><input type='text' name='phone' value="<?php echo ($data["phone"]); ?>" class="login_input user_icon"/></div></li>
