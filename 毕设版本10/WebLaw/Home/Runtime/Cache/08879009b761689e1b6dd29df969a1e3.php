...
<div class="regBox">
	...
	<form action='__URL__/do_login_manager' method='post' name='myForm'>
		<ul class="login">
			
		<li><span class="reg_item">管理员账户：</span><div class="input_item"><input type='text' name='username'class="login_input user_icon"/></div></li>
