...
<body>
	...
	<div class="login_cont">
            ...
            <form action='__URL__/create_manager' method='post' name='myForm'>
		<ul class="login">
		...
		<li><span class="reg_item">备注：</span><div class="input_item"><input type='text' name='context' class="login_input user_icon"/></div></li>
