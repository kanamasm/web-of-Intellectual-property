...
<body>
	...
	<form action='__URL__/update_manager' method='post' name='myForm'>
		<ul class="login">
		<br/>
                 	<input type='hidden' name='id'value="<?php echo ($data["id"]); ?>" />
		<li><span class="reg_item">用户名：</span><div class="input_item"><input type='text' name='username'value="<?php echo ($data["username"]); ?>" class="login_input user_icon"/></div></li>
		<li><span class="reg_item">密码：</span><div class="input_item"><input type="text" name='password' value="<?php echo ($data["password"]); ?>" class="login_input user_icon"/></div></li>
		<li><span class="reg_item">备注：</span><div class="input_item"><input type='text' name='context' value="<?php echo ($data["context"]); ?>" class="login_input user_icon"/></div></li>
