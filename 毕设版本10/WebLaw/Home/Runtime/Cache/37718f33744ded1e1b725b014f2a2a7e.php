...
<html>
	...
	<div class="logoBar red_logo">
		<div class="comWidth">
			...
			<h3 class="welcome_title">感谢使用计算机专利交易网，欢迎注册</h3>
		</div>
	</div>
</div>
	...
	<form action='__URL__/doReg' method='post' name='myForm'>
		<ul class="login">
			...
			<li><span class="reg_item">账户名：</span><div class="input_item"><input type='text' name='username'class="login_input user_icon"/></div></li>
			<li><span class="reg_item">密码：</span><div class="input_item"><input type="password" name='password' class="login_input user_icon"/></div></li>
			<li><span class="reg_item">确认密码：</span><div class="input_item"><input type="password" name='repassword' class="login_input user_icon"/></div></li>
			<li><span class="reg_item">联系电话：</span><div class="input_item"><input type="text" name='phone' class="login_input user_icon"/></div></li>
