...
<body>
	...
	<form action='__URL__/update_comment' method='post' name='myForm'>
		<ul class="login">
		<br/>
                 	<input type='hidden' name='id'value="<?php echo ($data["id"]); ?>" />
		<li><span class="reg_item">对象：</span><div class="input_item"><input type='text' name='username'value="<?php echo ($data["username"]); ?>" class="login_input user_icon"/></div></li>
		<li><span class="reg_item">时间：</span><div class="input_item"><input type="text" name='time' value="<?php echo (date('Y-m-d H:i:s',$data["time"])); ?>" class="login_input user_icon"/></div></li>
		<li><span class="reg_item">发送人：</span><div class="input_item"><input type='text' name='who' value="<?php echo ($data["who"]); ?>" class="login_input user_icon"/></div></li>
		<li><span class="reg_item">内容：</span><div class="input_item"><input type='text' name='substance' value="<?php echo ($data["substance"]); ?>" class="login_input user_icon"/></div></li>
...
<!--左侧列表-->
        <div class="menu">
            <div class="cont">
			    ...
			    <dd><a style="color:hsl(185, 97%, 45%);" href="__URL__/manager_comment">留言信息</a></dd>
                        </dl>
                    </li>
<li>
